...
class TestHW04a(unittest.TestCase):
    ...
    @patch('HW04a.getUserRepoCommits')
    def testMyRepo(self, mock_getUserRepoCommits): 
        mock_getUserRepoCommits.return_value = 'Mocked data'
        self.assertNotEqual(getUserRepoCommits('ronnie-melao'), 'Mocked data', 'Wrong commits')
        #self.assertNotEqual(getUserRepoCommits('ronnie-melao'),'Repo: CS-546 Number of commits: 30\nRepo: HW00-Tools_Setup Number of commits: 1\nRepo: HW01-Testing-triangle-classification Number of commits: 1\nRepo: HW02 Number of commits: 13\nRepo: HW04 Number of commits: 27','Wrong commits')
        
    @patch('HW04a.getUserRepoCommits')
    def testRichKempinski(self, mock_getUserRepoCommits): 
        mock_getUserRepoCommits.return_value = 'Mocked data'
        self.assertNotEqual(getUserRepoCommits('richkempinski'), 'Mocked data', 'Wrong commits')
