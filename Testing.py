...
from HW04a.py import getUserRepoCommits

class TestHW04a(unittest.TestCase):

    def testMyRepo(self): 
        self.assertMultiLineEqual(getUserRepoCommits('ronnie-melao'),'Repo: CS-546 Number of commits: 30\nRepo: HW00-Tools_Setup Number of commits: 1\nRepo: HW01-Testing-triangle-classification Number of commits: 1\nRepo: HW02 Number of commits: 13\nRepo: HW04 Number of commits: 17','Wrong commits')
